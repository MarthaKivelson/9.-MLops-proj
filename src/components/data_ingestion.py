...
class DataIngestion:
    ...
    def split_data_as_train_test(self, dataframe: DataFrame) -> None:
        ...
        logging.info("Enterd split_data_as_train_test method of Data ingestion class")

        try:
            train_set, test_set = train_test_split(dataframe, test_size=self.data_ingestion_config.train_test_split_ratio)
            logging.info("Performed train test split method")
            ...
            logging.info("Exported train & test file to the path")
    ...
    def initialize_data_ingestion(self) -> DataIngestionArtifact:
        ...
        On Failure  :   Write an exception log and then raise an exception
        """
        logging.info("Entered initialize_data_ingetion method of Data_ingestion class ")
        ...
        try:
            ...
            logging.info("Performed tarin test split on the dataset")
