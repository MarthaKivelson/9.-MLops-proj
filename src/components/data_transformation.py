...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            mn_columns = self._schema_config['mm_columns']
            ...
            preprocessor = ColumnTransformer(
                transformers=[
                    ...
                    ("MinMaxScalar", min_max_scalar, mn_columns)
                ],
    ...
    def _rename_columns(self, df):
        try:
            ...
            logging.info("Rename specific columns & casting to int")
            df.rename(columns={
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            input_features_train_df = self._drop_id_columns(input_features_train_df)
            ...
            input_features_test_df = self._drop_id_columns(input_features_test_df)
            ...
            logging.info("Custom transformation applied to train & test data")
            ...
            #logging.info(input_features_test_df.head())
            ...
            input_features_test_final, target_features_test_final = smt.fit_resample(
                input_feature_test_arr, target_features_test_df
            )   
            logging.info("SMOOTEENN applied to train-test df")

            train_arr = np.c_[input_feature_train_final, np.array(target_features_train_final)]
            test_arr = np.c_[input_features_test_final, np.array(target_features_test_final)]
            logging.info("Feature target concat done for train-test df")

            save_object(self.data_transformation_config.transformed_object_file_path, preprocessor)
            save_numpy_array_data(self.data_transformation_config.transformed_train_file_path, array=train_arr)
            save_numpy_array_data(self.data_transformation_config.transformed_test_file_path, array=test_arr)
            logging.info("Saving transformation object & file")
